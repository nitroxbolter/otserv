local mType = Game.createMonsterType("Nineveth")
local monster = {}

monster.description = "a Nineveth"
...
monster.defenses = {
	defense = 55,
	armor = 55,
	{name ="combat", interval = 3000, chance = 10, type = COMBAT_HEALING, minDamage = 380, maxDamage = 380, effect = 185, target = false},
}
