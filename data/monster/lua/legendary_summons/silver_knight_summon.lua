local mType = Game.createMonsterType("Kaldor")
local monster = {}

monster.description = "a Kaldor"
...
monster.attacks = {
	...
	{name ="sudden death rune", interval = 2000, chance = 17, minDamage = -300, maxDamage = -450, range = 7, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -200, maxDamage = -350, range = 6, radius = 2, effect = CONST_ME_MORTAREA, target = true},
...
monster.defenses = {
	defense = 55,
	armor = 55,
	{name ="combat", interval = 3000, chance = 10, type = COMBAT_HEALING, minDamage = 580, maxDamage = 580, effect = 185, target = false},
}
