...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -150, maxDamage = -1000, range = 7, shootEffect = CONST_ANI_ENERGY, effect = 214, target = false},
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -1000, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = 203, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -150, maxDamage = -1000, length = 7, spread = 3, effect = 207, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HOLYDAMAGE, minDamage = -150, maxDamage = -1000, length = 7, spread = 3, effect = 201, target = false},
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -1000, radius = 5, effect = 200, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -150, maxDamage = -1000, range = 7, radius = 5, effect = 209, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -150, maxDamage = -350, range = 1, effect = 197, target = true}
}
