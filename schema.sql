...
CREATE TABLE IF NOT EXISTS `players` (
  ...
  `skill_crafting` bigint unsigned NOT NULL DEFAULT 10,
  `skill_crafting_tries` int unsigned NOT NULL DEFAULT 0,
  `skill_woodcutting` int unsigned NOT NULL DEFAULT 10,
  `skill_woodcutting_tries` bigint unsigned NOT NULL DEFAULT 0,
  `skill_mining` int unsigned NOT NULL DEFAULT 10,
  `skill_mining_tries` bigint unsigned NOT NULL DEFAULT 0,
  `skill_herbalist` int unsigned NOT NULL DEFAULT 10,
  `skill_herbalist_tries` bigint unsigned NOT NULL DEFAULT 0,
  `ancestral_points` int unsigned NOT NULL DEFAULT 0,
  `ancestral_rank_points` bigint unsigned NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
